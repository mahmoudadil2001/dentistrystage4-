...
if st.session_state.chat_open:
    ...
    # iframe للدردشة - استبدل الرابط الخاص بك في src
    # هذا رابط صفحة دردشة Tawk.to التي يمكن عرضها ضمن iframe (يفضل أن يكون رابط صفحة ويب خاصة بالدردشة)
    # لكن للأسف Tawk.to لا تسمح بعرض widget داخل iframe بشكل رسمي. هنا مثال للتوضيح.
    tawk_iframe = """
