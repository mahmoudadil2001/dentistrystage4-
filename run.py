...
# زر قناة التلي + الملاحظة
st.markdown('''
<div style="display:flex; justify-content:center; margin-top:50px;">
  <a href="https://t.me/dentistryonly0" target="_blank" style="display:inline-flex; align-items:center; background:#0088cc; color:#fff; padding:10px 20px; border-radius:30px; text-decoration:none; font-size:18px; font-family:sans-serif;">
    قناة التلي
    <span style="width:24px; height:24px; background:#fff; border-radius:50%; display:flex; justify-content:center; align-items:center; margin-right:10px; margin-left:10px;">
...
<div style="text-align:center; color:black; margin-top:12px; font-size:15px; font-family:sans-serif;">
  اشتركوا بقناة التلي حتى توصللكم كل التحديثات أو المحاضرات اللي راح ننزلها على الموقع إن شاء الله
</div>
