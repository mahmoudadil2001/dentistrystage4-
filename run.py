...
if "user_logged" not in st.session_state:
    ...
    if st.button("✅ موافق"):
        if name.strip() == "" or group.strip() == "":
            ...
            st.experimental_rerun()  # استعمل rerun بطريقة صحيحة
...
# تشغيل التطبيق الأساسي (الاختبارات والمحاضرات)
orders_o()

# رابط التليجرام
st.markdown('''<div style="display:flex; justify-content:center; margin-top:50px;">
<a href="https://t.me/io_620" target="_blank" style="display:inline-flex; align-items:center; background:#0088cc; color:#fff; padding:8px 16px; border-radius:30px; text-decoration:none; font-family:sans-serif;">
حسابي على التلي
...
</svg></span></a></div>''', unsafe_allow_html=True)
