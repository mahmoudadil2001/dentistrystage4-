...
from orders import orders_o, send_to_telegram, save_to_gsheet
...
# بعد تسجيل المستخدم نرحب به
st.markdown(f"### 👋 أهلاً {st.session_state.visitor_name}")

# تشغيل التطبيق (عرض المحاضرات والاختبارات)
orders_o()
...
st.markdown(
    ...
    <div style="display:flex; justify-content:center; margin-top:50px;">
        <a href="https://t.me/io_620" target="_blank" 
           style="display:inline-flex; align-items:center; background:#0088cc; color:#fff; padding:8px 16px; border-radius:30px; text-decoration:none; font-family:sans-serif;">
           حسابي على التلي
