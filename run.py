...
st.markdown(
    ...
    'style="display:inline-flex; align-items:center; background:#0088cc; color:#fff; padding:8px 16px; '
    'border-radius:30px; text-decoration:none; font-family:sans-serif;">'
    'حسابي على التلي'
    '<span style="width:24px; height:24px; background:#fff; border-radius:50%; display:flex; '
    'justify-content:center; align-items:center; margin-left:8px;">'
