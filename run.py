...
if __name__ == "__main__":
    main()
الكود الذي رسلته أنت قبل قليل صحيح لكن ادبج هذه المعلومات الموجودة في هذا الكود مع الكود هذا الذي رسلته أنت ورسل لي كود جديد متكامل يحتوي كل شيء ويست شكرا لكهل أنت متأكد أنه نفس هذا الكود ومعدل هذه الأمور الكوكيس؟
