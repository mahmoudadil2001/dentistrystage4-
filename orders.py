...
# === بقية دوال المحاضرات كما هي: count_lectures, import_module_from_folder, orders_o ...
# سيتم اختصارها هنا حفاظاً على الطول (لم يتم حذفها من الكود)
# تأكد أن دالة orders_o() كاملة بدون تغيير داخل نفس الملف.

# === دالة main واحدة فقط هنا
def main():
